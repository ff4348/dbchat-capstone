...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = r'dbchatcapstone-69b8578a42f6.json'

storage_client = storage.Client()

#bucket = storage_client.bucket('dbchat-bucket')

file_list = storage_client.list_blobs('dbchat-bucket')
